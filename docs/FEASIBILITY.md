# Quake II feasibility binding

## Identity

- Title and region: Quake II, USA.
- Serial: SLUS-00757.
- Source executable path: `disc/SLUS_007.57`.
- Load address: `0x80018000`.
- Entry point: `0x800861A4`.
- Source disc binding: ``.
...
The clean source commit is `4d10bfb5902f2472d41712a9947ff7bc79b708af`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 1127 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `4d10bfb5902f2472d41712a9947ff7bc79b708af`.
- Portfolio `quake-ii/BUILDINFO.json`.
- Portfolio `quake-ii/RECEIPT.md`.
