...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/quake-ii-recomp/total)](https://github.com/Alexbeav/quake-ii-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/quake-ii-recomp/latest/total)](https://github.com/Alexbeav/quake-ii-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/quake-ii-recomp)](https://github.com/Alexbeav/quake-ii-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Quake II** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

Quake II recompiled for modern systems using psxrecomp.
...
This license does not cover Quake II content, generated retail code, artwork,
...
Zip prefix for CI artifacts: `quake-ii-recomp`.
